...
// MongoDB Connection
mongoose.connect("mongodb+srv://balanagaraj007:Bala007@cluster0.6lohydp.mongodb.net/ecommerce?retryWrites=true&w=majority&appName=Cluster0")
...
app.post(
  ...
  async (req, res) => {
    try {
      ...
      exec(
        `py -3.8 ./VITON-HD/test.py --name ${uniqueName} --checkpoint_dir ./VITON-HD/checkpoints --dataset_dir ./VITON-HD/datasets`,
        (error, stdout, stderr) => {
          if (error) {
